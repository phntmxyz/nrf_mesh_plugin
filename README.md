...
In a tab based layout, it provides example usage on :
 ...
 # Related links
- [Android-nRF-Mesh-Library] ([fork](https://github.com/NordicSemiconductor/Android-nRF-Mesh-Library))
- [iOS-nRF-Mesh-Library] ([fork](https://github.com/NordicSemiconductor/IOS-nRF-Mesh-Library))
